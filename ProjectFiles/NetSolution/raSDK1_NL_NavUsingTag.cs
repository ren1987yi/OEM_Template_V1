...
public class raSDK1_NL_NavUsingTag : BaseNetLogic
{
    ...
    public void NavTag()
    {
        ...
        try
        {
            ...
            lib = ((string)logixTag.Children.GetVariable(library).RemoteRead(2000).Value).Replace('-', '_');
            lType = (string)logixTag.Children.GetVariable(libraryType).RemoteRead(2000).Value;
